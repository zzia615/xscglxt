<%@ Page Title="" Language="C#" MasterPageFile="~/MainSite.Master" AutoEventWireup="true" CodeBehind="XsglAdd.aspx.cs" Inherits="xscglxt.XsglAdd" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<div class="form-group">
    <asp:Label ID="Label1" runat="server" Text="学号" for="xsbm"></asp:Label>
    <asp:TextBox ID="xsbm" runat="server" placeholder="请输入学号" CssClass="form-control"></asp:TextBox>
