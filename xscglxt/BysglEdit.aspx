<%@ Page Title="" Language="C#" MasterPageFile="~/MainSite.Master" AutoEventWireup="true" CodeBehind="BysglEdit.aspx.cs" Inherits="xscglxt.BysglEdit" %>
...
<div class="form-group">
    <asp:Label ID="Label7" runat="server" Text="毕业日期" for="byrq"></asp:Label>
    <asp:TextBox ID="byrq" runat="server" placeholder="yyyy/MM/dd" CssClass="form-control"></asp:TextBox>
    <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ErrorMessage="毕业日期不能为空" ControlToValidate="byrq" ForeColor="Red" Display="Dynamic"></asp:RequiredFieldValidator>
    <asp:RangeValidator ID="RangeValidator1" runat="server" ErrorMessage="毕业日期输入不合法" ControlToValidate="byrq" ForeColor="Red" Display="Dynamic" Type="Date" MaximumValue="2999-12-31" MinimumValue="2000-01-01"></asp:RangeValidator>
</div>

<asp:Button ID="Button1" runat="server" Text="修改" CssClass="btn btn-primary" OnClick="Button1_Click"/>
<a href="Bysgl.aspx" class="btn btn-light ml-1">返回毕业生管理</a>
</asp:Content>
